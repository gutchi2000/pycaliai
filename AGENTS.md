...
| **Cowork**（Anthropic Codex Desktop App） | 馬券種・点数・予算配分・見送り判断 | `reports/cowork_output/{date}_bets.json` |
...
```
1. Codex Desktop に reports/cowork_input/{date}_bundle.json を投入
